...
// This file shows how to use beyondcoinj from Javascript.
// To run, grab the beyondcoinj bundled JAR and then do something like this:
//
//   jjs -cp beyondcoinj-0.12-bundled.jar demo.js
//
...
//
//   jjs -cp beyondcoinj-0.12-bundled.jar
//
...
//
//   jjs -cp beyondcoinj-0.12-bundled.jar:$slf4fj demo.js
//
...
// Nashorn, unlike V8, is thread safe (because it runs on the JVM). And beyondcoinj is a threaded library. This means you
