...
import org.beyondcoinj.core.AddressFormatException;
import org.beyondcoinj.core.Coin;
import org.beyondcoinj.core.NetworkParameters;
import org.beyondcoinj.params.AbstractBitcoinNetParams;
 ...
 *
 * <ul>
 * <li>{@code beyondcoin:<address>}</li>
 * <li>{@code beyondcoin:<address>?<name1>=<value1>&<name2>=<value2>} with multiple
...
public class BitcoinURI {
    ...
    /**
     * URI for Bitcoin network. Use {@link org.beyondcoinj.params.AbstractBitcoinNetParams#BITCOIN_SCHEME} if you specifically
     * need Bitcoin, or use {@link org.beyondcoinj.core.NetworkParameters#getUriScheme} to get the scheme
     * from network parameters.
     */
    @Deprecated
    public static final String BITCOIN_SCHEME = "beyondcoin";
    ...
    public BitcoinURI(@Nullable NetworkParameters params, String input) throws BitcoinURIParseException {
        ...
        // URI is formed as  beyondcoin:<address>?<query parameters>
        // blockchain.info generates URIs of non-BIP compliant form beyondcoin://address?....
        // We support both until Ben fixes his code.
        
        // Remove the beyondcoin scheme.
        // (Note: getSchemeSpecificPart() is not used as it unescapes the label and parse then fails.
        // For instance with : beyondcoin:129mVqKUmJ9uwPxKJBnNdABbuaaNfho4Ha?amount=0.06&label=Tom%20%26%20Jerry
        ...
        if (addressSplitTokens.length == 0)
            throw new BitcoinURIParseException("No data found after the beyondcoin: prefix");
     ...
     *         10,000,000 units is 1 BYND. May be null if no amount is specified
     */
