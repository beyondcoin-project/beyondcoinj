...
public final class Coin implements Monetary, Comparable<Coin>, Serializable {
    ...
    /**
     * The number of satoshis equal to one beyondcoin.
     */
    ...
    private static final MonetaryFormat FRIENDLY_FORMAT = MonetaryFormat.BYND.minDecimals(2).repeatOptionalDecimals(1, 6).postfixCode();
    ...
    private static final MonetaryFormat PLAIN_FORMAT = MonetaryFormat.BYND.minDecimals(0).repeatOptionalDecimals(1, 8).noCode();

    /**
     * <p>
     * Returns the value as a plain string denominated in BYND.
     * The result is unformatted with no trailing zeroes.
     * For instance, a value of 150000 satoshis gives an output string of "0.0015" BYND
     * </p>
     */
