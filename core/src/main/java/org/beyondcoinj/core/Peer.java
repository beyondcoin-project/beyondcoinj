...
import org.beyondcoinj.net.StreamConnection;
import org.beyondcoinj.store.BlockStore;
import org.beyondcoinj.store.BlockStoreException;
import org.beyondcoinj.utils.ListenerRegistration;
 ...
 * {@link org.beyondcoinj.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link org.beyondcoinj.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link org.beyondcoinj.net.NioClientManager#openConnection(java.net.SocketAddress, StreamConnection)}
     * or
     * {@link org.beyondcoinj.net.NioClient#NioClient(java.net.SocketAddress, StreamConnection, int)}.</p>
     *
    ...
    /**
     * <p>Construct a peer that reads/writes from the given block chain. Transactions stored in a {@link org.beyondcoinj.core.TxConfidenceTable}
    ...
    private void processVersionMessage(VersionMessage m) throws ProtocolException {
        ...
        // beyondcoinj is a client mode implementation. That means there's not much point in us talking to other client
     ...
     * Once the pong is received the value returned by {@link org.beyondcoinj.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link org.beyondcoinj.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link org.beyondcoinj.core.Peer#ping()} has never
