...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * FP rate is chosen for performance rather than privacy. If a future version of beyondcoinj fixes the known
     ...
     * {@link org.beyondcoinj.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link org.beyondcoinj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link org.beyondcoinj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link org.beyondcoinj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link org.beyondcoinj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link org.beyondcoinj.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link org.beyondcoinj.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link org.beyondcoinj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link org.beyondcoinj.core.Peer#ping()}.
     */
     ...
     * and easy way for a user to upgrade a beyondcoinj based app running in SPV mode to fully validating security.
     */
