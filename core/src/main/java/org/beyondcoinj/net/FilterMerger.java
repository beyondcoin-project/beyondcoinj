...
/**
 * <p>A reusable object that will calculate, given a list of {@link org.beyondcoinj.core.PeerFilterProvider}s, a merged
 * {@link org.beyondcoinj.core.BloomFilter} and earliest key time for all of them.
 * Used by the {@link org.beyondcoinj.core.PeerGroup} class internally.</p>
 *
