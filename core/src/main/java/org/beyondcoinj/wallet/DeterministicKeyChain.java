 ...
 * {@link org.beyondcoinj.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link org.beyondcoinj.crypto.MnemonicCode},
 ...
 * {@link org.beyondcoinj.crypto.DeterministicKey#serializePubB58(org.beyondcoinj.core.NetworkParameters)}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link org.beyondcoinj.crypto.DeterministicKey#deserializeB58(org.beyondcoinj.crypto.DeterministicKey, String, org.beyondcoinj.core.NetworkParameters)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(org.beyondcoinj.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link org.beyondcoinj.crypto.DeterministicHierarchy} and
 * {@link org.beyondcoinj.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
    ...
    public List<DeterministicKey> getKeys(KeyPurpose purpose, int numberOfKeys) {
        ...
        try {
            ...
            for (int i = 0; i < numberOfKeys; i++) {
                ...
                // by any real problem reports from beyondcoinj users, but I've heard of cases via the grapevine of
     ...
     * The returned key can be serialized and then passed into {@link #watch(org.beyondcoinj.crypto.DeterministicKey)}
     ...
     * @see org.beyondcoinj.wallet.MarriedKeyChain
     */
