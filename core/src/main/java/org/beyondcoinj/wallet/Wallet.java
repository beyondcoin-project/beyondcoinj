...
package org.beyondcoinj.wallet;
...
import org.beyondcoinj.core.listeners.*;
import org.beyondcoinj.core.AbstractBlockChain;
import org.beyondcoinj.core.Address;
import org.beyondcoinj.core.BlockChain;
import org.beyondcoinj.core.BloomFilter;
import org.beyondcoinj.core.Coin;
import org.beyondcoinj.core.Context;
import org.beyondcoinj.core.ECKey;
import org.beyondcoinj.core.FilteredBlock;
import org.beyondcoinj.core.InsufficientMoneyException;
import org.beyondcoinj.core.Message;
import org.beyondcoinj.core.NetworkParameters;
import org.beyondcoinj.core.Peer;
import org.beyondcoinj.core.PeerFilterProvider;
import org.beyondcoinj.core.PeerGroup;
import org.beyondcoinj.core.ScriptException;
import org.beyondcoinj.core.Sha256Hash;
import org.beyondcoinj.core.StoredBlock;
import org.beyondcoinj.core.Transaction;
import org.beyondcoinj.core.TransactionBag;
import org.beyondcoinj.core.TransactionBroadcast;
import org.beyondcoinj.core.TransactionBroadcaster;
import org.beyondcoinj.core.TransactionConfidence;
import org.beyondcoinj.core.TransactionInput;
import org.beyondcoinj.core.TransactionOutPoint;
import org.beyondcoinj.core.TransactionOutput;
import org.beyondcoinj.core.UTXO;
import org.beyondcoinj.core.UTXOProvider;
import org.beyondcoinj.core.UTXOProviderException;
import org.beyondcoinj.core.Utils;
import org.beyondcoinj.core.VerificationException;
import org.beyondcoinj.core.TransactionConfidence.*;
import org.beyondcoinj.crypto.*;
import org.beyondcoinj.script.*;
import org.beyondcoinj.signers.*;
import org.beyondcoinj.utils.*;
import org.beyondcoinj.wallet.Protos.Wallet.*;
import org.beyondcoinj.wallet.WalletTransaction.*;
import org.beyondcoinj.wallet.listeners.KeyChainEventListener;
import org.beyondcoinj.wallet.listeners.ScriptsChangeEventListener;
import org.beyondcoinj.wallet.listeners.WalletChangeEventListener;
import org.beyondcoinj.wallet.listeners.WalletCoinsReceivedEventListener;
import org.beyondcoinj.wallet.listeners.WalletCoinsSentEventListener;
import org.beyondcoinj.wallet.listeners.WalletEventListener;
import org.beyondcoinj.wallet.listeners.WalletReorganizeEventListener;
import org.slf4j.*;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.beyondcoinj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
     ...
     * {@link org.beyondcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.beyondcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.beyondcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.beyondcoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.beyondcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.beyondcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.beyondcoinj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.beyondcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.beyondcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.beyondcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.beyondcoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.beyondcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.beyondcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * key, after loading a wallet produced by previous versions of beyondcoinj. If the wallet is encrypted the key
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.beyondcoinj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.beyondcoinj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.beyondcoinj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.beyondcoinj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws org.beyondcoinj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.beyondcoinj.crypto.KeyCrypter,
     ...
     * {@link org.beyondcoinj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link org.beyondcoinj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.beyondcoinj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    /**
     * Returns the amount of beyondcoin ever received via output. <b>This is not the balance!</b> If an output spends from a
    ...
    /**
     * Returns the amount of beyondcoin ever sent via output. If an output is sent to our own wallet, because of change or
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link org.beyondcoinj.signers.TransactionSigner.MissingSignatureException}
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.beyondcoinj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.beyondcoinj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
