...
/**
 * <p>A KeyChainGroup is used by the {@link org.beyondcoinj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.beyondcoinj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.beyondcoinj.crypto.KeyCrypterScrypt}.
     *
     * @throws org.beyondcoinj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
