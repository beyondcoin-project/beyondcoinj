...
public class PaymentProtocol {
    ...
    public static final String MIMETYPE_PAYMENTREQUEST = "application/beyondcoin-paymentrequest";
    public static final String MIMETYPE_PAYMENT = "application/beyondcoin-payment";
    public static final String MIMETYPE_PAYMENTACK = "application/beyondcoin-paymentack";
