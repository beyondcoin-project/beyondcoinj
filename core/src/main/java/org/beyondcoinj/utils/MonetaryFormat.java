...
import org.beyondcoinj.core.Monetary;
...
public final class MonetaryFormat {
    ...
    /** Standard format for the BYND denomination. */
    public static final MonetaryFormat BYND = new MonetaryFormat().shift(0).minDecimals(2).repeatOptionalDecimals(2, 3);
    ...
    /** Standard format for the µBYND denomination. */
    ...
    public static final String CODE_LTC = "BYND";
    /** Currency code for base 1/1000 Beyondcoin. */
    public static final String CODE_MLTC = "mBYND";
    /** Currency code for base 1/1000000 Beyondcoin. */
    public static final String CODE_ULTC = "µBYND";
    ...
    /**
     * Set number of digits to shift the decimal separator to the right, coming from the standard BYND notation that was
    ...
    /**
     * Parse a human readable coin value to a {@link org.beyondcoinj.core.Coin} instance.
     * 
    ...
    /**
     * Parse a human readable fiat value to a {@link org.beyondcoinj.utils.Fiat} instance.
     * 
     * @throws NumberFormatException
     *             if the string cannot be parsed for some reason
     */
