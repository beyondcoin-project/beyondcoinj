...
import org.beyondcoinj.protocols.channels.PaymentChannelClient.VersionSelector;
import org.beyondcoinj.testing.TestWithWallet;
import org.beyondcoinj.utils.Threading;
import org.beyondcoinj.wallet.Wallet;
import org.beyondcoinj.wallet.WalletExtension;
import org.beyondcoinj.wallet.WalletFiles;
...
import static org.beyondcoinj.protocols.channels.PaymentChannelClient.VersionSelector.*;
import static org.beyondcoinj.protocols.channels.PaymentChannelCloseException.CloseReason;
import static org.beyondcoinj.testing.FakeTxBuilder.createFakeBlock;
import static org.beyondcoin.paymentchannel.Protos.TwoWayChannelMessage.MessageType;
...
public class ChannelConnectionTest extends TestWithWallet {
    ...
    private static Wallet roundTripClientWallet(Wallet wallet) throws Exception {
        ...
        org.beyondcoinj.wallet.Protos.Wallet proto = WalletProtobufSerializer.parseToProto(new ByteArrayInputStream(bos.toByteArray()));
