...
import static org.beyondcoinj.core.Coin.CENT;
import static org.beyondcoinj.core.Coin.COIN;
import static org.beyondcoinj.core.Coin.SATOSHI;
import static org.beyondcoinj.core.Coin.ZERO;
...
public class MonetaryFormatTest {
    ...
    private static final MonetaryFormat NO_CODE = MonetaryFormat.BYND.noCode();
    ...
    public void standardCodes() throws Exception {
        assertEquals("BYND 0.00", MonetaryFormat.BYND.format(Coin.ZERO).toString());
    ...
    public void codeOrientation() throws Exception {
        assertEquals("BYND 0.00", MonetaryFormat.BYND.prefixCode().format(Coin.ZERO).toString());
        assertEquals("0.00 BYND", MonetaryFormat.BYND.postfixCode().format(Coin.ZERO).toString());
    }

    @Test
    public void codeSeparator() throws Exception {
        assertEquals("BYND@0.00", MonetaryFormat.BYND.codeSeparator('@').format(Coin.ZERO).toString());
    }
