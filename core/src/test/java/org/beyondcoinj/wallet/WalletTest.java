...
import org.beyondcoinj.core.listeners.TransactionConfidenceEventListener;
import org.beyondcoinj.core.AbstractBlockChain;
import org.beyondcoinj.core.Address;
import org.beyondcoinj.core.Block;
...
import org.beyondcoinj.core.PeerAddress;
...
import org.beyondcoinj.core.TransactionConfidence.ConfidenceType;
import org.beyondcoinj.crypto.*;
import org.beyondcoinj.script.Script;
import org.beyondcoinj.script.ScriptBuilder;
import org.beyondcoinj.signers.StatelessTransactionSigner;
import org.beyondcoinj.signers.TransactionSigner;
import org.beyondcoinj.store.BlockStoreException;
import org.beyondcoinj.store.MemoryBlockStore;
import org.beyondcoinj.testing.*;
import org.beyondcoinj.utils.ExchangeRate;
import org.beyondcoinj.utils.Fiat;
import org.beyondcoinj.utils.Threading;
import org.beyondcoinj.wallet.Wallet.BalanceType;
import org.beyondcoinj.wallet.WalletTransaction.Pool;
...
import org.beyondcoinj.wallet.Protos.Wallet.EncryptionType;
...
import static org.beyondcoinj.core.Utils.HEX;
import static org.beyondcoinj.testing.FakeTxBuilder.*;
...
public class WalletTest extends TestWithWallet {
    ...
    public void doubleSpends() throws Exception {
        ...
        buf[43] = 0;  // Break the signature: beyondcoinj won't check in SPV mode and this is easier than other mutations.
    ...
    public void spendToSameWallet() throws Exception {
        ...
        assertEquals(ZERO, wallet.getBalance());
        sendMoneyToWallet(AbstractBlockChain.NewBlockType.BEST_CHAIN, outbound1);
        // We should have a balance of 1 BYND after the block is received.
        assertEquals(coin1, wallet.getBalance());
    }
    ...
    public void autosaveImmediate() throws Exception {
        ...
        File f = File.createTempFile("beyondcoinj-unit-test", null);
    ...
    public void opReturnTwoOutputsTest() throws Exception {
        // Tests sending transaction where one output transfers BYND, the other one writes OP_RETURN.
        receiveATransaction(wallet, myAddress);
        Transaction tx = new Transaction(PARAMS);
        Coin messagePrice = Coin.ZERO;
        Script script = ScriptBuilder.createOpReturnScript("hello world!".getBytes());
    ...
    public void totalReceivedSent() throws Exception {
        // Receive 4 BYND in 2 separate transactions
        ...
        // Send 3 BYND in a single transaction
