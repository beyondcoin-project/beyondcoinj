...
import org.beyondcoinj.store.FullPrunedBlockStore;
import org.beyondcoinj.utils.BlockFileLoader;
...
import static org.beyondcoinj.core.Coin.FIFTY_COINS;
...
public abstract class AbstractFullPrunedBlockChainTest {
    ...
    public void testGetOpenTransactionOutputs() throws Exception {
        ...
        // Create beyondcoin spend of 1 BYND.
    ...
    public void testUTXOProviderWithWallet() throws Exception {
        ...
        // Create 1 BYND spend to a key in this wallet (to ourselves).
        ...
        // Create another spend of 1/2 the value of BYND we have available using the wallet (store coin selector).
        ...
        // The availbale balance should be the 0 (as we spent the 1 BYND that's pending) and estimated should be 1/2 - fee BYND
        assertEquals("Available balance is incorrect", Coin.ZERO, wallet.getBalance(Wallet.BalanceType.AVAILABLE));
