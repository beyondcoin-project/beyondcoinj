...
public class CoinTest {
    ...
    public void testToFriendlyString() {
        assertEquals("1.00 BYND", COIN.toFriendlyString());
        assertEquals("1.23 BYND", valueOf(1, 23).toFriendlyString());
        assertEquals("0.001 BYND", COIN.divide(1000).toFriendlyString());
        assertEquals("-1.23 BYND", valueOf(1, 23).negate().toFriendlyString());
    }
