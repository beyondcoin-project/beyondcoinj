...
package org.beyondcoinj.tools;

import org.beyondcoinj.core.*;
import org.beyondcoinj.crypto.*;
import org.beyondcoinj.params.MainNetParams;
import org.beyondcoinj.params.RegTestParams;
import org.beyondcoinj.params.TestNet3Params;
import org.beyondcoinj.protocols.payments.PaymentProtocol;
import org.beyondcoinj.protocols.payments.PaymentProtocolException;
import org.beyondcoinj.protocols.payments.PaymentSession;
import org.beyondcoinj.script.ScriptBuilder;
import org.beyondcoinj.store.*;
import org.beyondcoinj.uri.BitcoinURI;
import org.beyondcoinj.uri.BitcoinURIParseException;
import org.beyondcoinj.utils.BriefLogFormatter;
import org.beyondcoinj.wallet.DeterministicSeed;
import org.beyondcoinj.wallet.DeterministicUpgradeRequiredException;
import org.beyondcoinj.wallet.DeterministicUpgradeRequiresPassword;
...
import org.beyondcoinj.core.listeners.BlocksDownloadedEventListener;
import org.beyondcoinj.core.listeners.DownloadProgressTracker;
import org.beyondcoinj.wallet.MarriedKeyChain;
import org.beyondcoinj.wallet.Protos;
import org.beyondcoinj.wallet.SendRequest;
import org.beyondcoinj.wallet.Wallet;
import org.beyondcoinj.wallet.WalletExtension;
import org.beyondcoinj.wallet.WalletProtobufSerializer;
...
import static org.beyondcoinj.core.Coin.parseCoin;
...
public class WalletTool {
    ...
    private static org.beyondcoin.protocols.payments.Protos.PaymentRequest paymentRequest;
    ...
    private static void sendPaymentRequest(String location, boolean verifyPki) {
        if (location.startsWith("http") || location.startsWith("beyondcoin")) {
            try {
                ...
                System.err.println("Invalid beyondcoin uri: " + e.getMessage());
                System.exit(1);
            } catch (InterruptedException e) {
                // Ignore.
            } catch (ExecutionException e) {
            ...
            try {
                paymentRequest = org.beyondcoin.protocols.payments.Protos.PaymentRequest.newBuilder().mergeFrom(stream).build();
            } catch(IOException e) {
